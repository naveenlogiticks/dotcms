 ...
 * Generated at: 2019-11-28 18:51:03 UTC
...
public final class sub_005fnav_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.dotmarketing.portlets.contentlet.struts.ContentletForm");
...
//	Skin skin = user.getSkin();
	...
	try {
      ...
      out.write("function viewFormsList()\r\n");
      out.write("{\r\n");
      out.write("\tvar href = \"");
      //  portlet:actionURL
      ...
      try {
        ...
        // /html/portlet/ext/contentlet/sub_nav.jsp(11,13) name = windowState type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
